...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0011_auto_20210527_1911'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_measure', models.CharField(help_text='Единица измерения для конкретного фильтра. Например "Частота процессора (Gz). Единицей измерения будет информация в скобках."', max_length=50, verbose_name='Единица измерения для фильтра')),
