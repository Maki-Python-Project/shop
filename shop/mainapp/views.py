...
from .models import Category, Customer, CartProduct, Order, Product, ProductFeatures
...
class ChangeQTYView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        cart_product.save()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "Кол-ва успешно изменено")
        return HttpResponseRedirect('/cart/')
...
class ProfileView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'profile.html', {'orders': orders, 'cart': self.cart})